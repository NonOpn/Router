...
var /* string */ dec2Hex = function(n: number): string {
...
var /* String */ arrayToHex = function(array: number[]): string {
  var log="";
  var k;
...
function ESP3HeaderCRC(h: any): any {
  var u8CRC = 0;
...
function ESP3DataCRC(h: any): any{
  var u8CRC = 0;
  var i=0;
  for(;i<h.length; i++){
...
function buildTelegram(packetType: any, data: any, optionaldata: any) {
...
export default class EnoceanSend {
  buildTelegram(packetType: any, data: any, optionaldata: any) {
